...
#SBATCH --job-name=mimic-abl-eval-test-marginalized-binary-learned-linear-capacity-starved-n25-30d-random-docs
#SBATCH --array=0-14
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=mimic-abl-marginalized-binary-learned-linear-capacity-starved-test-random-docs-rep${REP}-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
