...
#              checkpoint at train50pct -- reproduction gate, real docs
...
#   sbatch scripts/eval_test_marginalized_binary_learned_linear_data_scarcity_train50pct_repro.sh
# ============================================================

#SBATCH --job-name=mimic-ds-abl-marginalized-repro-train50pct
#SBATCH --array=0-4
...
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_data_scarcity_n25_30d_train50pct_test_eval_repro/draw${DRAW}"
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=mimic-ds-abl-marginalized-repro-train50pct-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
