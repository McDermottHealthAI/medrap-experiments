...
#              checkpoint at train20pct -- frozen null-doc ablation
...
#   sbatch scripts/eval_test_marginalized_binary_learned_linear_data_scarcity_train20pct_null_docs.sh
# ============================================================

#SBATCH --job-name=mimic-ds-abl-marginalized-null-docs-train20pct
#SBATCH --array=0-4
...
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_data_scarcity_n25_30d_train20pct_test_eval_null_docs/draw${DRAW}"
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=mimic-ds-abl-marginalized-null-docs-train20pct-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
