...
#              checkpoint at train10pct -- frozen random-doc ablation, 3 reps x 5 draws
...
#   sbatch scripts/eval_test_marginalized_binary_learned_linear_data_scarcity_train10pct_random_docs.sh
# ============================================================

#SBATCH --job-name=mimic-ds-abl-marginalized-random-docs-train10pct
#SBATCH --array=0-14
...
LABELS_DIR="/groups/mm6677_gp/hs3627/medrap-experiments/mimic_iv_sweep/data/tasks_zach_uniform_event_n25_30d_train10pct/draw${DRAW}/tasks"
TRAIN_OUTPUT_DIR="/groups/mm6677_gp/hs3627/medrap-experiments/mimic_iv_sweep/outputs/marginalized_binary_data_scarcity_n25_30d_train10pct/draw${DRAW}"
CHECKPOINT_PATH="${TRAIN_OUTPUT_DIR}/checkpoints/last.ckpt"
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_data_scarcity_n25_30d_train10pct_test_eval_random_docs_rep${REP}/draw${DRAW}"
...
echo "  Duration      : 30d"
echo "  Draw          : ${DRAW}/5"
echo "  query_projector: sequence_mean_1024 (learned-linear), FULL capacity, train10pct"
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=mimic-ds-abl-marginalized-random-docs-rep${REP}-train10pct-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
