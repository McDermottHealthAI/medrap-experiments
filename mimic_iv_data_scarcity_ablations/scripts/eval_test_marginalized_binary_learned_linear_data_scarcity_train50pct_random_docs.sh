...
#              checkpoint at train50pct -- frozen random-doc ablation, 3 reps x 5 draws
...
#   sbatch scripts/eval_test_marginalized_binary_learned_linear_data_scarcity_train50pct_random_docs.sh
# ============================================================

#SBATCH --job-name=mimic-ds-abl-marginalized-random-docs-train50pct
#SBATCH --array=0-14
...
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_data_scarcity_n25_30d_train50pct_test_eval_random_docs_rep${REP}/draw${DRAW}"
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=mimic-ds-abl-marginalized-random-docs-rep${REP}-train50pct-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
