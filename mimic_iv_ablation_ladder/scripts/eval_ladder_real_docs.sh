...
#
# retriever.k=4 is the trained k. Holding K fixed across all three
...
#SBATCH --job-name=eval-ladder-real-docs
#SBATCH --array=0-79
...
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/eval_real_docs/${SELECTION}/seed${MODEL_SEED}/n${N}"
