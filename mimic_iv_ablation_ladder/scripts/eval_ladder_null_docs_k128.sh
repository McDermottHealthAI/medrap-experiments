...
#              retriever.k=128. 2 code selections x 5 model seeds x 8 N values.
# ------------------------------------------------------------
...
# draw.
#
# retriever.k=128 is the trained k on purpose: holding K at its training value
...
#SBATCH --job-name=eval-ladder-null-docs-k128-k128
#SBATCH --array=0-79
...
NULL_DB="${REPO_DIR}/data/retrieval_db_null_512"
...
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/eval_null_docs_k128/${SELECTION}/seed${MODEL_SEED}/n${N}"
