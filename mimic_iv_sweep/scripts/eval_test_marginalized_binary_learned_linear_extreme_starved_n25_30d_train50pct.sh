...
# marginalized(binary, learned-linear), train50pct checkpoints.
# ============================================================

#SBATCH --job-name=eval-test-marginalized-binary-learned-linear-extreme-starved-train50pct
#SBATCH --array=0-4
...
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_extreme_starved_n25_30d_train50pct_test_eval/draw${DRAW}"
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=eval-test-marginalized-binary-learned-linear-extreme-starved-train50pct-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
