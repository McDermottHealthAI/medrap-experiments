...
# EXTREME capacity cut, N=1 task codes. Pairs with
# sweep_patient_only_task_count_ablation_n1.sh.
# ------------------------------------------------------------
# METHODOLOGY CAVEAT: see sweep_patient_only_task_count_ablation_n1.sh --
# reuses OLD pre-anchor-fix labels, single draw.
#
# Usage:
#   cd mimic_iv_sweep
#   sbatch scripts/sweep_marginalized_binary_learned_linear_task_count_ablation_n1.sh
# ============================================================

#SBATCH --job-name=sweep-marginalized-task-count-n1
...
OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_task_count_ablation_n1"
...
echo "=== Job info ==="
echo "  query_projector: sequence_mean_1024, EXTREME capacity cut, N=1 tasks"
echo "  Started       : $(date)"
echo ""
...
medrap-train \
    ...
    do_overwrite=true \
    "wandb_run_name=marginalized-task-count-n1-extreme-starved-${SLURM_JOB_ID:-local}" \
    "$@"
