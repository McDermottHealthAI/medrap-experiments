...
# marginalized(binary, learned-linear), train5pct checkpoints.
# ============================================================

#SBATCH --job-name=eval-test-marginalized-binary-learned-linear-extreme-starved-train5pct
#SBATCH --array=0-4
...
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_extreme_starved_n25_30d_train5pct_test_eval/draw${DRAW}"
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=eval-test-marginalized-binary-learned-linear-extreme-starved-train5pct-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
