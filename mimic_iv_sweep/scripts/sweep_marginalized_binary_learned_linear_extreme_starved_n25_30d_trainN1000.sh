...
# (N=1000). Pairs with sweep_patient_only_extreme_starved_n25_30d_trainN1000.sh.
# ------------------------------------------------------------
...
# Usage:
#   cd mimic_iv_sweep
#   sbatch scripts/sweep_marginalized_binary_learned_linear_extreme_starved_n25_30d_trainN1000.sh
# ============================================================

#SBATCH --job-name=sweep-marginalized-extreme-starved-trainN1000
#SBATCH --array=0-4
...
OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_extreme_starved_n25_30d_trainN1000/draw${DRAW}"
...
echo "=== Job info ==="
echo "  Draw          : ${DRAW}/5"
echo "  query_projector: sequence_mean_1024, EXTREME capacity cut, trainN=1000"
...
medrap-train \
    ...
    do_overwrite=true \
    "wandb_run_name=marginalized-extreme-starved-trainN1000-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
