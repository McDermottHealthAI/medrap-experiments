...
# EXTREME capacity cut, N=64 task codes. Pairs with
# sweep_patient_only_task_count_ablation_n64.sh.
# ------------------------------------------------------------
# METHODOLOGY CAVEAT: see sweep_patient_only_task_count_ablation_n64.sh --
# reuses OLD pre-anchor-fix labels, single draw.
#
# Usage:
#   cd mimic_iv_sweep
#   sbatch scripts/sweep_marginalized_binary_learned_linear_task_count_ablation_n64.sh
# ============================================================

#SBATCH --job-name=sweep-marginalized-task-count-n64
...
LABELS_DIR="${REPO_DIR}/data/tasks/n64/tasks"
OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_task_count_ablation_n64"
...
echo "=== Job info ==="
echo "  query_projector: sequence_mean_1024, EXTREME capacity cut, N=64 tasks"
echo "  Started       : $(date)"
echo ""
...
medrap-train \
    ...
    do_overwrite=true \
    "wandb_run_name=marginalized-task-count-n64-extreme-starved-${SLURM_JOB_ID:-local}" \
    "$@"
