...
#SBATCH --job-name=sweep-marginalized-binary-learned-linear-capacity-starved-n25-30d
#SBATCH --array=0-4
...
medrap-train \
    ...
    do_overwrite=true \
    "wandb_run_name=marginalized-binary-learned-linear-capacity-starved-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
