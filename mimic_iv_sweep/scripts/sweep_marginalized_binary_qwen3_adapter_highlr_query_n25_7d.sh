...
#              sweep_marginalized_binary_qwen3_adapter_query_n25_7d.sh, but
...
# than its own std) and regressed slightly at 7d (Delta -0.0104, worse than
...
# Usage:
#   cd mimic_iv_sweep
#   sbatch scripts/sweep_marginalized_binary_qwen3_adapter_highlr_query_n25_7d.sh
# ============================================================

#SBATCH --job-name=sweep-marginalized-binary-qwen3-adapter-highlr-query-n25-7d
#SBATCH --array=0-4
...
OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_qwen3_adapter_highlr_query_n25_7d/draw${DRAW}"
...
# Same combo as sweep_marginalized_binary_qwen3_adapter_query_n25_7d.sh --
...
medrap-train \
    ...
    do_overwrite=true \
    "wandb_run_name=marginalized-binary-qwen3-adapter-highlr-query-d7-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
