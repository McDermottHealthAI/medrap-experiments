...
#              SET subsampled to 10% of subjects (tuning/held_out are
...
# ------------------------------------------------------------
# See sweep_patient_only_data_scarcity_n25_30d_train10pct.sh for the
...
# Usage:
#   cd mimic_iv_sweep
#   sbatch scripts/sweep_marginalized_binary_learned_linear_data_scarcity_n25_30d_train10pct.sh
# ============================================================

#SBATCH --job-name=sweep-marginalized-binary-data-scarcity-n25-30d-train10pct
#SBATCH --array=0-4
...
OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_data_scarcity_n25_30d_train10pct/draw${DRAW}"
...
# 10%-subsampled train split) differ here.
medrap-train \
    encoder=rope \
    pooling=masked_mean \
    head=linear \
    ...
    do_overwrite=true \
    "wandb_run_name=marginalized-binary-data-scarcity-train10pct-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
