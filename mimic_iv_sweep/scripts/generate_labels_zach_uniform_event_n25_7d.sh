...
# ------------------------------------------------------------
# Fixed N=25 random task codes, 5 independent random draws, 7-day fixed
# occurrence window only (the requested "one set of experiments" slice --
# see generate_labels_duration_variance_n25.sh for the full 7d+30d version
...
#   data/tasks_zach_uniform_event_n25_7d/draw<d>/tasks/{train,tuning,held_out}.parquet
#
# Usage:
#   cd mimic_iv_sweep
...
#SBATCH --job-name=gen-labels-zach-uniform-event-n25-7d
#SBATCH --array=0-4
...
OUTPUT_DIR="${REPO_DIR}/data/tasks_zach_uniform_event_n25_7d/draw${DRAW}"
