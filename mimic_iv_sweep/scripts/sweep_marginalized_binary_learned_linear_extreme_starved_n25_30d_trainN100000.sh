...
# (N=100000). Pairs with sweep_patient_only_extreme_starved_n25_30d_trainN100000.sh.
# ------------------------------------------------------------
...
# Usage:
#   cd mimic_iv_sweep
#   sbatch scripts/sweep_marginalized_binary_learned_linear_extreme_starved_n25_30d_trainN100000.sh
# ============================================================

#SBATCH --job-name=sweep-marginalized-extreme-starved-trainN100000
#SBATCH --array=0-4
...
OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_extreme_starved_n25_30d_trainN100000/draw${DRAW}"
...
echo "=== Job info ==="
echo "  Draw          : ${DRAW}/5"
echo "  query_projector: sequence_mean_1024, EXTREME capacity cut, trainN=100000"
echo "  max_epochs    : 3, warmup_steps: 200"
echo "  Started       : $(date)"
echo ""
...
medrap-train \
    ...
    do_overwrite=true \
    "wandb_run_name=marginalized-extreme-starved-trainN100000-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
