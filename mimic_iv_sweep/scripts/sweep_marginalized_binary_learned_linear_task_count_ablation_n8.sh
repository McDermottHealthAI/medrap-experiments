...
# EXTREME capacity cut, N=8 task codes. Pairs with
# sweep_patient_only_task_count_ablation_n8.sh.
# ------------------------------------------------------------
# METHODOLOGY CAVEAT: see sweep_patient_only_task_count_ablation_n8.sh --
# reuses OLD pre-anchor-fix labels, single draw.
#
# Usage:
#   cd mimic_iv_sweep
#   sbatch scripts/sweep_marginalized_binary_learned_linear_task_count_ablation_n8.sh
# ============================================================

#SBATCH --job-name=sweep-marginalized-task-count-n8
...
LABELS_DIR="${REPO_DIR}/data/tasks/n8/tasks"
OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_task_count_ablation_n8"
...
echo "=== Job info ==="
echo "  query_projector: sequence_mean_1024, EXTREME capacity cut, N=8 tasks"
echo "  Started       : $(date)"
echo ""
...
medrap-train \
    ...
    do_overwrite=true \
    "wandb_run_name=marginalized-task-count-n8-extreme-starved-${SLURM_JOB_ID:-local}" \
    "$@"
