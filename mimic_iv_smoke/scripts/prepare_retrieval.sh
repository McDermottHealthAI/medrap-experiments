...
#
# Same as mimic_iv/scripts/prepare_retrieval_slurm.sh, updated for the
# post-refactor flat CLI (medrap-prepare-retrieval-dataset, not
...
#   sbatch scripts/prepare_retrieval.sh --num-docs 1000
#   sbatch scripts/prepare_retrieval.sh --num-docs 10000
#
# Subset sizes intended for ablation: 10, 100, 1000, 10000, full.
# ============================================================

#SBATCH --job-name=medrap-smoke-prep-retrieval
