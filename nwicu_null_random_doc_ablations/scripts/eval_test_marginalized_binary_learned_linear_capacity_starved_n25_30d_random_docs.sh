...
# ============================================================
# ============================================================
# NWICU REPLICATION of mimic_iv_sweep/scripts/eval_test_marginalized_binary_learned_linear_capacity_starved_n25_30d.sh
...
#SBATCH --job-name=nwicu42-eval-test-marginalized-binary-learned-linear-capacity-starved-n25-30d-random-docs
#SBATCH --array=0-14
...
TRAIN_OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_capacity_starved_n25_30d/draw${DRAW}"
CHECKPOINT_PATH="${TRAIN_OUTPUT_DIR}/checkpoints/last.ckpt"
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_learned_linear_capacity_starved_n25_30d_test_eval_random_docs_rep${REP}/draw${DRAW}"
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=nwicu42-marginalized-binary-learned-linear-capacity-starved-test-random-docs-rep${REP}-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
