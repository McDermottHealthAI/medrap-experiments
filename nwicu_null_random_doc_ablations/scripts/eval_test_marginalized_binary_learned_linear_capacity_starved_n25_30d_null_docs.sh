...
#SBATCH --job-name=nwicu42-eval-test-marginalized-binary-learned-linear-capacity-starved-n25-30d-null-docs
#SBATCH --array=0-4
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=nwicu42-marginalized-binary-learned-linear-capacity-starved-test-null-docs-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
