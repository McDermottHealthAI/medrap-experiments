...
# ============================================================
# ============================================================
# NWICU REPLICATION of mimic_iv_sweep/scripts/sweep_patient_only_capacity_starved_n25_30d.sh
...
#SBATCH --job-name=nwicu42-sweep-patient-only-capacity-starved-n25-30d
#SBATCH --array=0-4
...
medrap-train \
    ...
    do_overwrite=true \
    "wandb_run_name=nwicu42-patient-only-capacity-starved-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
