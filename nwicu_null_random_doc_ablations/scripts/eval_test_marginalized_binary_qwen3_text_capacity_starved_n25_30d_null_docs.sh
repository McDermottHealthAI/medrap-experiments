...
#SBATCH --job-name=nwicu42-eval-test-marginalized-binary-qwen3-text-capacity-starved-n25-30d-null-docs
#SBATCH --array=0-4
...
EVAL_OUTPUT_DIR="${REPO_DIR}/outputs/marginalized_binary_qwen3_text_capacity_starved_n25_30d_test_eval_null_docs/draw${DRAW}"
...
medrap-eval \
    ...
    do_overwrite=true \
    "wandb_run_name=nwicu42-marginalized-binary-qwen3-text-capacity-starved-test-null-docs-d30-draw${DRAW}-${SLURM_ARRAY_JOB_ID:-local}_${IDX}" \
    "$@"
